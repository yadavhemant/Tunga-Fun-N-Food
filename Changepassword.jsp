...
<link rel="stylesheet" href="style1.css" type="text/css"/>        
    ...
    <body onLoad="f2()" bgcolor="darkorange">
      ...
      <br>
      <h1><font color="blue">Change Password Form</font></h1>
      <hr color="red" size=10 width=50%>
      <table>
          <tr>
              <form name="form1" method="post" action="passsuccess.jsp">
              <td><font color=black>Enter  User Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
              <td><input type=text name="user" size="18.5"></td>
          </tr><tr></tr>
          <tr>
              <td><font color=black>Enter Old Password&nbsp;&nbsp;&nbsp;</td>
              <td><input type=password name="pass"></td>
          </tr><tr></tr>
          <tr>
              <td><font color=black>Enter New Password&nbsp;&nbsp;</td>
