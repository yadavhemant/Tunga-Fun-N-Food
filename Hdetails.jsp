 ...
 <link rel="stylesheet" href="style1.css" type="text/css"/>
    ...
    <body onLoad="f2()" bgcolor="darkorange">
      ...
      try{
          ...
          PreparedStatement s=con.prepareStatement("select * from Hdetails");
          ResultSet rs=s.executeQuery();
         out.println("<center><font color='blue' size=20><b>Tunga Hotel Details</b></font></center>");
         out.println("<br><table border=1 bodercolor=black align=center bgcolor=orange><tr><td><b><font color=red size=6>HotelCode</td><td><font color=red size=6><b>HotelName</td><td><b><font color=red size=6>City</td><td><b><font color=red size=6>Rooms</td><td><b><font color=red size=6>Meeting Room</td><td><b><font color=red size=6>Banquet Hall</td><td><b><font color=red size=6>Price Per Day</td></tr>");
          while(rs.next())
              {
