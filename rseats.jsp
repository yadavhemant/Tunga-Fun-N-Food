 ...
 <link rel="stylesheet" href="style1.css" type="text/css"/>
    ...
    <body onLoad="f2()" bgcolor="darkorange">
      ...
      try{
          ...
          PreparedStatement s=con.prepareStatement("select * from Rseats");
          ResultSet rs=s.executeQuery();
         out.println("<center><font color='blue' size=20><b>Restaurant Seats Details</b></font></center>");
         out.println("<br><table border=1 bodercolor=black align=center bgcolor=orange><tr><td><b><font color=red size=6>Rest.Code</td><td><font color=red size=6><b>Restaurant Name</td><td><b><font color=red size=6>Rest.  City</td><td><b><font color=red size=6>Total Tables</td><td><b><font color=red size=6>Booking Tables</td><td><b><font color=red size=6>Available Table</td></tr>");
          while(rs.next())
              {
               out.println("<tr><td><font color=black size=4><b>"+rs.getString(1)+"</td><td><font color=black size=4><b>"+rs.getString(2)+"</td><td><font color=black size=4><b>"+rs.getString(3)+"</td><td><font color=black size=4><b>"+rs.getInt(4)+"</td><td><font color=black size=4><b>"+rs.getInt(5)+"</td><td><font color=black size=4><b>"+rs.getInt(6)+"</td></tr>") ;
              }
              out.println("</table>");
      }
