...
<html>
    ...
    <body onLoad="f2()" bgcolor="darkorange">
        ...
        <BR>    
         <A HREF="rorder.jsp"><img src=back.jpg height=25 width=100></A>
        <br><br><br><br>
    <%
           ...
           s=con.prepareStatement("delete from rbooking where Order_No="+orno+"");
          int val= s.executeUpdate();
            ...
            catch(NumberFormatException ce)
            {
               ...
               out.println("<h1 align=center>Enter OrderNo in Number Format.</h1>"+ce);
            }
