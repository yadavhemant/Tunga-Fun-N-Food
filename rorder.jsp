...
<script src="JScript1.js"></script>
 <link rel="stylesheet" href="style1.css" type="text/css"/>
    ...
    <body onLoad="f2()" bgcolor="darkorange">
      ...
      %>
      <br>
       <table align=center width=300><form name="form2" method="post" action="rcancel.jsp">
