 ...
 <link rel="stylesheet" href="style1.css" type="text/css"/>
    ...
    <body onLoad="f2()" bgcolor="darkorange">
      ...
      try{
          ...
          PreparedStatement s=con.prepareStatement("select * from Rdetails");
          ResultSet rs=s.executeQuery();
         out.println("<center><font color='blue' size=20><b>Tunga Restaurant Details</b></font></center>");
         out.println("<br><table border=1 bodercolor=black align=center bgcolor=orange><tr><td><b><font color=red size=6>Rest. Code</td><td><font color=red size=6><b>Rest. Name</td><td><b><font color=red size=6>Rest. City</td><td><b><font color=red size=6>Total Dining Rooms</td><td><b><font color=red size=6>Tables Per Room</td><td><b><font color=red size=6>Chairs Per Table</td><td><b><font color=red size=6>Price Per Table</td></tr>");
          while(rs.next())
              {
